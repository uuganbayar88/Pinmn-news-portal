...
export default function ShareRail() {
  ...
  return (
    <div className={styles.shareRail}>
      <button className={styles.shareBtn} aria-label="Facebook-т хуваалцах" onClick={() => toast("Facebook-т хуваалцах цонх (демо)")}>
      ...
      <button className={styles.shareBtn} aria-label="X-д хуваалцах" onClick={() => toast("X-д хуваалцах цонх (демо)")}>
        <svg viewBox="0 0 24 24"><path d="M18.9 1.2h3.7l-8.1 9.3L24 23.2h-7.5l-5.9-7.7-6.7 7.7H.2l8.7-9.9L0 1.2h7.7l5.3 7 5.9-7z" /></svg>
      </button>
      <button className={styles.shareBtn} aria-label="Линк хуулах" onClick={() => toast("Линк хуулагдлаа ✓")}>
      ...
      <button className={styles.shareBtn} aria-label="Пинлэх" onClick={() => toast("Пинлэгдлээ 📌")} style={{ color: "var(--accent)" }}>
        📌
      </button>
